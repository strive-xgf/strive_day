package com.xgf.util.rabbitmq.exchange.direct;
...
public class ConsumerDirectExchange {
    public static void main(String[] args) throws Exception {
        ...
        String queueName = "defaultDirectQueue";
        String exchangeName = RabbitMqConstant.MqExchange.EXCHANGE_DIRECT_NAME;
        String exchangeType = RabbitMqConstant.MqExchangeType.EXCHANGE_TYPE_DIRECT;
        String routingKey = RabbitMqConstant.MqTag.TAG_DIRECT_DEFAULT_NAME;
        ...
        System.out.println("====== ConsumerDirectExchange 开始消费 ======");
        int count = 1;
        // 循环获取消息
        while (true) {
            ...
            System.err.println("消费端 ConsumerDirectExchange 消费信息: " + msg + "\t time = " + DateUtil.dateFormatString(new Date(), DateUtil.FORMAT_MILL) + "\t消费数: " + count++);
        }
    }
}