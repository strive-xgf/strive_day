...
/**
 * @author xgf
 * @create 2022-09-12 11:35
 * @description 发布订阅模式，广播模式【Exchange type = fanout】
 */
public class ConsumerFanoutExchangeTwo {
    public static void main(String[] args) throws Exception {
        ...
        String queueName = "consumerFanoutExchangeTwo";
        //无需指定路由key
        String routingKey = "";
        ...
        System.out.println("====== ConsumerFanoutExchangeTwo 开始消费 ======");
        int count = 1;
        // 循环获取消息
        while (true) {
            ...
            System.err.println("消费端 ConsumerFanoutExchangeTwo 消费信息: " + msg + "\t time = " + DateUtil.dateFormatString(new Date(), DateUtil.FORMAT_MILL) + "\t消费数: " + count++);
        }
    }
}
