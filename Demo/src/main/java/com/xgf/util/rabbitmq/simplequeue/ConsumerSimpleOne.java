 ...
 * 轮询分发：导致每个消费者消费的消息数是均等的，而不是基于实际消费能力
 */
public class ConsumerSimpleOne {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 获取消息进行消费
        System.out.println("====== ConsumerSimpleOne 开始消费 ======");
        ...
        while(true){
            ...
            System.err.println("消费端 ConsumerSimpleOne 消费信息: " + msg + "\t time = " + DateUtil.dateFormatString(new Date(), DateUtil.FORMAT_MILL) + "\t消费数: " + count++);
        }
    }
}
