 ...
 */
public class ConsumerSimpleThree {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 获取消息进行消费
        System.out.println("====== ConsumerSimpleThree 开始消费 ======");
        ...
        while(true){
            ...
            System.err.println("消费端 ConsumerSimpleThree 消费信息: " + msg + "\t time = " + DateUtil.dateFormatString(new Date(), DateUtil.FORMAT_MILL) + "\t消费数: " + count++);
        }
    }
}
